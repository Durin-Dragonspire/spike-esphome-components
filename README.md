...
Use immutable release `fingerprint-grow-v2.2.0` from ESPHome:
...
external_components:
  - source:
      ...
      ref: fingerprint-grow-v2.2.0
    components:
      - fingerprint_grow
    refresh: never
```

The already-published `fingerprint-grow-v1.0.0`, `fingerprint-grow-v2.0.0`, and
`fingerprint-grow-v2.1.0` tags remain available for YAML generated against
