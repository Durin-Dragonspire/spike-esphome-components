...
Use immutable release `fingerprint-grow-v2.5.0` from ESPHome:
...
`fingerprint-grow-v2.1.0`, `fingerprint-grow-v2.2.0`,
`fingerprint-grow-v2.3.0`, and `fingerprint-grow-v2.4.0` tags remain available
